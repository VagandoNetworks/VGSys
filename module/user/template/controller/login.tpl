            ...
            <div class="signin-wrapper">
                ...
                <form id="signin-form" class="signin" method="post" action="#signin">
                    <fieldset>
                        ...
                        <p class="help-text-inlines">{lang var='signin.lost_password'}</p>
                    </fieldset>
                    <div class="prompt">
                        <div class="holding">
                            <input type="submit" name="btnSend" value="{lang var='signin.signin'}" class="btn btn-primary" />
                            <fieldset class="subchck">
                                <label class="remember">    
                                    <input type="checkbox" value="1" name="remember_me" /> {lang var='signin.remember_me'}
                                </label>
                            </fieldset>
                        </div>
                    </div>
